...
statusbar = ttk.Label(big_frame, anchor="w", relief="sunken")
statusbar.pack(side="bottom", fill="x")

statusbar_count = ttk.Label(statusbar, anchor="s", relief="flat", width="13")
...
statusbar_action = ttk.Label(statusbar, anchor="s", relief="flat", width="50")
